        ...
        <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            ...
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="hero-text col-span-6">
                    <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Una tiendita pequeña de prueba nomás </h1>
                    ...
                    <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
                        <a target="_blank" href="https://github.com/masterawss/practice-ecommerce-vite-tailwind" class="apple bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                            <div class="logo">
                                <img src="https://cdn.worldvectorlogo.com/logos/github-icon.svg" class="w-9" alt="">
                            </div>
                            <div class="text">
                                <p class=" text-xs text-gray-600" style="font-size: 0.5rem;">Visita el repositorio</p>
                                <p class=" text-xs font-semibold text-gray-900">Github</p>
                            </div>
                        </a>
                    </div>
                </div>
