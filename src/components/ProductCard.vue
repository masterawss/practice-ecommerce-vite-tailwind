        ...
        <div class="flex-none lg:flex">
            <div class=" h-full w-full lg:h-48 lg:w-48   lg:mb-0 mb-3">
                ...
                <div class="grid grid-cols-3 gap-1 mt-2">
                    <img v-for="image,i in producto.images" :src="image.tumbnail" :key="i" class="w-full object-cover object-center rounded-md" :class="{'opacity-30 ' : (producto.image_activated !== image.image)}" @click="producto.image_activated = image.image"/>
                </div>
            </div>
            ...
            <div class="flex-auto ml-3 justify-evenly py-2">
                <div class="flex flex-wrap ">
                    <h2 class="flex-auto text-lg font-medium">{{producto.name}}c</h2>
                ...
                <div class="flex py-4  text-sm text-gray-500">
                    <div class="flex-1 inline-flex items-center">
                        <p class="bold text-">S/ {{new Intl.NumberFormat("es-pe").format(producto.price)}}</p>
                    </div>
                    <!-- <div class="flex-1 inline-flex items-center">
